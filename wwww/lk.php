...
<HTML>
	...
	<body class="is-preload">
      ...
      <section class="posts">
		...
		$foto="images/p$id.jpg";
		if (file_exists($foto))
		{
		?>
				<a class="image fit"><img width = "200" height = "300" src="images/p<?=$id?>.jpg" alt="" /></a>
		<?
		}
		else
		{
			?>
				<a class="image fit"><img width = "200" height = "300" src="images/op.jpg" alt="" /></a>
		<?
		}
    ...
    echo "<br>ваша почта :", $myrow['mail'],"<br>";
	  ...
	  $result = "SELECT Work_experience,mail,Qval,FIO FROM doctor WHERE ID_doctor = '$id'";
        ...
        $myrow = mysqli_fetch_array($result1);
		?>
				<a class="image fit"><img width = "200" height = "300" src="images/d<?=$id?>.jpg" alt="" /></a>
		<?
    echo "<br>ваше имя :", $myrow['FIO'];
    ...
    ?>
							...
							{
							      echo '<br><li><a href="MyP.php" class="button">Записавшиеся ко мне</a></li>';
								  echo  '<br><li><a href="ex.php" class="button">Выход</a></li><br>';
                            }
